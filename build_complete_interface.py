            ...
            <div class="info-card">
                ...
                <div class="grid" style="grid-template-columns:1fr 1fr;">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="ap_model" placeholder="gemini-2.5-flash-preview-05-20">
                    </div>
                </div>
                <div class="grid" style="grid-template-columns:1fr 1fr;">
...
function updateProviderFields() {
    ...
    else if (p === 'google_ai') m.placeholder = 'gemini-2.5-flash-preview-05-20';
...
function startAutopilot() {
    ...
    if (provider === 'google_ai') {
        ...
        if (!sendModel) sendModel = 'gemini-2.5-flash-preview-05-20';
