...
var TRANSLATIONS = {
    ru: {
        ...
        autopilot_help_google_colab: '<b>Бесплатная LLM через Google Colab:</b><br><br>1. Откройте <a href="https://colab.research.google.com/github/Slavikpro557/ai-neural-network-project/blob/main/colab_llm_server.ipynb" target="_blank" style="color:#667eea;text-decoration:underline;">ноутбук в Google Colab</a><br>2. Нажмите <b>Runtime → Run all</b> и следуйте инструкциям в ноутбуке<br>3. В конце появится зелёная рамка с URL — скопируйте его<br>4. Вставьте URL в поле <b>Endpoint</b> выше<br><br>💡 GPU Colab бесплатный, LLM работает на нём — ваш компьютер не нагружается.',
    ...
    en: {
        ...
        autopilot_help_google_colab: '<b>Free LLM via Google Colab:</b><br><br>1. Open the <a href="https://colab.research.google.com/github/Slavikpro557/ai-neural-network-project/blob/main/colab_llm_server.ipynb" target="_blank" style="color:#667eea;text-decoration:underline;">notebook in Google Colab</a><br>2. Click <b>Runtime → Run all</b> and follow the instructions in the notebook<br>3. A green box with your URL will appear at the end — copy it<br>4. Paste the URL into the <b>Endpoint</b> field above<br><br>💡 Colab GPU is free, the LLM runs there — your computer stays unloaded.',
